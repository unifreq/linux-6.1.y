...
#define RTL8126_NUM_LEDS            4
#define LEDFEATURE_MASK_8126        0xf1
#define LEDSEL_MASK_8126            0x1e2b
#define RTL8126_LED_CTRL_ACT_LO_HI  BIT(12)
#define RTL8126_LED_CTRL_LP_EN      BIT(11)
#define RTL8126_LED_CTRL_PREBOOT_EN BIT(10)
#define RTL8126_LED_CTRL_ACT        BIT(9)
#define RTL8126_LED_CTRL_LINK_2500  BIT(5)
#define RTL8126_LED_CTRL_LINK_1000  BIT(3)
#define RTL8126_LED_CTRL_LINK_100   BIT(1)
#define RTL8126_LED_CTRL_LINK_10    BIT(0)
